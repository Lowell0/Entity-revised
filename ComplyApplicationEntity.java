...
public class ComplyApplicationEntity {
	...
	public ComplyApplicationEntity(int comply_id, int application_no, String bldgpermit_no, String date_received,
			String applicants_name, String project_name, String address, String type_occupancy, String contact_no,
			String email, String date_inspected, int inspection_no, String date_ntc, int ntc_no, String team_leader,
			String[] fire_inspectors, ArrayList<String[]> defects, String administrative_fine, String status) {
		super();
	...
	public String getDate_ntc() {
		return date_ntc;
	}

	public void setDate_ntc(String date_ntc) {
		this.date_ntc = date_ntc;
	}
