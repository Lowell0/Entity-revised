...
public class RenewalbpNoticeCorrectViolationEntity {
	...
	public RenewalbpNoticeCorrectViolationEntity(int renewncv_id, String bspermit_no, String permittee,
			String business_name, String address, String nature_business, String type_occupancy, String contact_no,
			String email, String date_received, String date_inspected, int inspection_no, String ntc_date, int ntc_no,
			String ntcv_date, int ntcv_no, String team_leader, String fire_inspector, ArrayList<String[]> defects,
			String date, String name, String administrative_fine, String status) {
		super();
