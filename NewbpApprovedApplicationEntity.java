...
public class NewbpApprovedApplicationEntity {
	...
	public NewbpApprovedApplicationEntity(int newbp_id, String bspermit_no, String permittee, String business_name,
			...
			String date_received, String date_inspection, int inspection_np, int fsic_no, String fsic_date, int amount,
			int or_no, String date, String team_leadr, String fire_inspectors, String[] recommendation,
			String remarks) {
		super();
