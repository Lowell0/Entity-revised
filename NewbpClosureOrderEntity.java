...
public class NewbpClosureOrderEntity {
	...
	public NewbpClosureOrderEntity(int newco_id, String bspermit_no, String permittee, String business_name,
			...
			String team_leader, String fire_inspectors, ArrayList<String[]> defects, String name, String date,
