...
public class ApprovedApplicationEntity {
	...
	public ApprovedApplicationEntity(int approved_id, int application_no, int bldgpermit_no, String applicants_name,
			String project_name, String location, int contact_no, int fees, String date_received, String fsic_date,
			int fsic_no, double ammount, int or_no, String date, String nature_of_collection, String[] recommendations,
			String[] fire_inspectors, int inspection_no, String status) {
		super();
