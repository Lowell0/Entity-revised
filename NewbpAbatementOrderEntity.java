...
public class NewbpAbatementOrderEntity {
	...
	public NewbpAbatementOrderEntity(int newao_id, String bspermit_no, String permittee, String business_name,
			...
			String ntcv_date, int ntcv_no, String abatement_date, int abatement_no, String team_leader,
			String fire_inspectors, ArrayList<String[]> defects, String administrative_fine, int amount, String name,
	...
	public int getInpection_no() {
		return inspection_no;
	}


	public void setInpection_no(int inspection_no) {
		this.inspection_no = inspection_no;
	}
