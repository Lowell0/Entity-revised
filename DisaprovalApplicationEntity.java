...
public class DisaprovalApplicationEntity {
	...
	public DisaprovalApplicationEntity(int disapproval_id, int application_no, String bldgpermit_no,
			String date_received, String applicants_name, String project_name, String location, int contact_no,
			int ammount_paid, int nod_no, String date_nod, ArrayList<String[]> defects, String name, int inspection_no,
			String status) {
		super();
