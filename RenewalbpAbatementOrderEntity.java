...
public class RenewalbpAbatementOrderEntity {
	...
	public RenewalbpAbatementOrderEntity(int renewao_id, String bspermit_no, String permittee, String business_name,
			...
			String fire_inspector, ArrayList<String[]> defects, String date, String name, String administrative_fine,
			String status) {
		super();
